...
#define prod 10 //numero de productos
#define tur 3 //numero de turnos

using namespace std;
//Prototipos
void limpiar(int cantidad[prod][tur],int suma[prod],int sumaTurno[tur]);
void totalxProducto(int cantidad[prod][tur],int suma[prod]); 
void totalxTurno(int cantidad[prod][tur],int sumaTurno[tur]);
void productoMayor(int suma[prod],char producto[prod][60], int &producMayor,string &articMayor);
